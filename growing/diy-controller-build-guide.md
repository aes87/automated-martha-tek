...
**→ [Shopping List](https://aes87.github.io/automated-martha-tek/diy-controller-shopping-list.html)** — interactive checklist with persistent notes, syncs to your GitHub account.
