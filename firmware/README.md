...
**Hardware prerequisite:** [DIY Controller Build Guide](../mushroom-growing/setup/docs/diy-controller-build-guide.md)
...
See the [build guide](../mushroom-growing/setup/docs/diy-controller-build-guide.md) for full BOM,
